...
const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true, title: '登录' } },
  {
    ...
    children: [
      ...
      { path: 'policies', name: 'policies', component: () => import('@/views/PoliciesView.vue'), meta: { title: '检查规则', icon: 'shield' } },
      { path: 'apps', name: 'apps', component: () => import('@/views/AppsView.vue'), meta: { title: '服务', icon: 'server' } },
